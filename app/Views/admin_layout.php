 ...
 * Plantilla de layout para el panel de administración.
...
<head>
    ...
    <title>Admin Panel - CFTechBros</title>
    <!-- Tailwind CSS CDN -->
    ...
    <div class="flex h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <aside class="w-64 flex-shrink-0 bg-gray-800 dark:bg-black/25 p-4 flex flex-col">
            <div class="text-center mb-8">
                ...
                <span class="text-sm text-blue-300 block">Admin Panel</span>
            </div>
            <nav class="flex-grow">
                <ul class="space-y-2">
                    <li>
                        <a href="<?= BASE_URL ?>dashboard" class="sidebar-link <?= strpos($_SERVER['REQUEST_URI'], 'dashboard') ? 'active' : '' ?>">
                    ...
                    <li>
                        <a href="<?= BASE_URL ?>admin/users" class="sidebar-link <?= strpos($_SERVER['REQUEST_URI'], 'admin/users') ? 'active' : '' ?>">
                    ...
                    <li>
                        <a href="<?= BASE_URL ?>admin/roles" class="sidebar-link <?= strpos($_SERVER['REQUEST_URI'], 'admin/roles') ? 'active' : '' ?>">
                    ...
                    <li>
                        <a href="<?= BASE_URL ?>admin/services" class="sidebar-link <?= strpos($_SERVER['REQUEST_URI'], 'admin/services') ? 'active' : '' ?>">
                    ...
                    <li>
                        <a href="<?= BASE_URL ?>admin/contacts" class="sidebar-link <?= strpos($_SERVER['REQUEST_URI'], 'admin/contacts') ? 'active' : '' ?>">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white dark:bg-gray-800 shadow-md p-4 flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                    <span class="text-gray-700 dark:text-gray-300">Hola, <?= htmlspecialchars(\App\Core\Session::get('username', 'Admin')) ?></span>
